use std::error::Error;
use crate::packet::{
    PacketSerialIn, PacketParsingError,
    PlayerConnectionState, PacketReceiver,
...
pub async fn handle(
    ...
    match id {
        receive::LoginStart::ID => { // Handle Login request
        ...
        receive::EncryptionResponse::ID => { // Handle Encryption Response
